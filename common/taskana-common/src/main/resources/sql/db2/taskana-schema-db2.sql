...
VALUES ('4.11.0', CURRENT_TIMESTAMP);
...
CREATE UNIQUE INDEX "DB2ADMIN"."IDX1805212034070"
    ON "TASKANA "."WORKBASKET" ("KEY" ASC, "DOMAIN" ASC) INCLUDE ("ORG_LEVEL_4", "ORG_LEVEL_3", "ORG_LEVEL_2",
...
CREATE UNIQUE INDEX "DB2ADMIN"."IDX1805212040470"
    ON "TASKANA "."WORKBASKET" ("KEY" ASC, "DOMAIN" ASC) INCLUDE ("ID") ALLOW REVERSE SCANS COLLECT SAMPLED DETAILED STATISTICS;
COMMIT WORK;
-- index[13],    0,126MB
